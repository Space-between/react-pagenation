...
describe('Button component', () => {
	...
	test('modal visible', async () => {
		...
		await waitFor(() => {
			const searchResult = wrapper.getByTestId('resultli_1').innerHTML.indexOf('블랙핑크'); // indexOf메소드를 이용하여 특정 문자가 시작되는 index값을 구할 수 있다. 지금 내가 찾고자 하는 것은 두번째 리스트에 있는 블랙핑크를 찾는 것이므로 0이 나온다.
